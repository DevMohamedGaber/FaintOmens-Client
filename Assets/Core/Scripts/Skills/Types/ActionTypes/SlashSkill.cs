...
namespace Game
{
    [CreateAssetMenu(menuName="Custom/Skill/Special/SlashSkill", order=999)]
    public class SlashSkill : TargetDamageSkill
    {
        public override void OnCastStarted(Entity caster)
        {
            ...
            if(effects != null && caster is Player player)
            {
                ...
                go.GetComponent<Components.AnimationEventEffects_Slashs>().caster = player;
            }
        }
    }
}