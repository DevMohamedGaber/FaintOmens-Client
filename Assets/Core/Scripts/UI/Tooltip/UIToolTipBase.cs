...
namespace Game.UI
{
    public class UIToolTipBase : MonoBehaviour {
        ...
        protected UIToolTipFrom from = UIToolTipFrom.None;
        protected Player player => Player.localPlayer;
        public void Set(UIToolTipFrom from, int index = -1) {
            this.from = from;
            this.index = index;
        }
        ...
        [Serializable] public struct ToolTip_Buttons {
            public UIBasicButton useItem;
            public UIBasicButton sell;
            public UIBasicButton trade;
            ...
            void Clear(UIBasicButton button) {
                if(button != null) {
